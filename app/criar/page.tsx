...
const btn = {display:'flex',justifyContent:'space-between',alignItems:'center',padding:'16px',background:'#111',border:'1px solid #222',borderRadius:'16px',color:'white',textDecoration:'none',marginBottom:'12px'}
const btnVerde = {...btn,background:'#00C851',border:'none',fontWeight:700}

return(
<div style={{background:'#0A0A0A',minHeight:'100vh',color:'white',padding:'24px',fontFamily:'system-ui',display:'flex',flexDirection:'column',alignItems:'center'}}>
...
{data.pix_key && <a href={`https://nubank.com.br/pagar/${data.pix_key}`} target="_blank" style={btnVerde}><span>💳 Pague com Pix - {data.pix_key}</span><span>→</span></a>}
