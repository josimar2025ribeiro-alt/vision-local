...
const [f,setF]=useState({title:"Minha Loja",slug:"minha-loja",logo:"",foto:"",wpp:"5519999999999",insta:"minhaloja",pix:"",wifi_ssid:"",wifi:"",loc:"RUA ARMINDO LONGO 187",logoSize:92,logoPos:"centro"})
...
<input style={inp} placeholder="Endereço ex: RUA ARMINDO LONGO 187, Holambra SP" value={f.loc} onChange={(e)=>{setF({...f,loc:e.target.value})}}/>
{f.loc? <div style={{background:'white',borderRadius:'16px',overflow:'hidden',marginTop:'10px',border:'2px solid #1a73e8'}}><div style={{padding:'8px',color:'#1a73e8',fontWeight:900,fontSize:'11px',textAlign:'center',background:'white'}}>Localização no Maps</div><img src="https://images.unsplash.com/photo-1524661135-423995f22d0b?w=600&h=300&fit=crop" style={{width:'100%',height:'130px',objectFit:'cover',display:'block'}} alt="mapa padrão"/><div style={{padding:'8px',background:'#E8F0FE',color:'#1a73e8',fontWeight:900,fontSize:'11px',textAlign:'center'}}>{f.loc}</div><a href={mapsLink} target="_blank" style={{display:'block',background:'#1a73e8',color:'white',padding:'12px',textAlign:'center',fontWeight:900,textDecoration:'none',fontSize:'12px'}}>Abrir no Google Maps</a></div> : null}
...
{f.loc? <div style={{background:'white',borderRadius:'16px',overflow:'hidden',border:'2px solid #1a73e8'}}><div style={{padding:'6px',color:'#1a73e8',fontWeight:900,fontSize:'10px',background:'white'}}>Localização no Maps</div><img src="https://images.unsplash.com/photo-1524661135-423995f22d0b?w=600&h=300&fit=crop" style={{width:'100%',height:'110px',objectFit:'cover'}} alt="mapa"/><div style={{padding:'6px',background:'#E8F0FE',color:'#1a73e8',fontWeight:900,fontSize:'10px'}}>{f.loc}</div><div style={{background:'#1a73e8',color:'white',padding:'10px',fontWeight:900,fontSize:'11px'}}>Abrir no Google Maps</div></div> : null}
</div>
</div>
</div>
</div>
