...
const [f,setF]=useState({title:"",slug:"",whatsapp:"",localizacao:"",video_url:"",pix_key:"",wifi_password:"",catalogo:"",instagram:"",servicos:"",agendamento:""});
...
<input placeholder="Instagram ex: https://instagram.com/loja" value={f.instagram} onChange={e=>setF({...f,instagram:e.target.value})} style={{padding:'12px',background:'#1A1A1A',color:'white'}}/>
<input placeholder="Link Nossos Serviços" value={f.servicos} onChange={e=>setF({...f,servicos:e.target.value})} style={{padding:'12px',background:'#1A1A1A',color:'white'}}/>
<input placeholder="Link Agendar Horário" value={f.agendamento} onChange={e=>setF({...f,agendamento:e.target.value})} style={{padding:'12px',background:'#1A1A1A',color:'white'}}/>
