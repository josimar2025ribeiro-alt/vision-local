...
{data.localizacao? <a href={data.localizacao} target="_blank" style={{background:'white',borderRadius:'20px',overflow:'hidden',border:'2px solid #1a73e8',display:'block',textDecoration:'none'}}><div style={{padding:'10px',fontWeight:900,color:'#1a73e8',fontSize:'12px',textAlign:'center'}}>Localização</div>{data.mapa_imagem_url? <img src={data.mapa_imagem_url} style={{width:'100%',height:'180px',objectFit:'cover',display:'block'}} alt="mapa"/> : <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/aa/Google_Maps_icon_%282020%29.svg/500px-Google_Maps_icon_%282020%29.svg.png" style={{width:'100%',height:'180px',objectFit:'contain',background:'#E8F0FE',padding:'20px',display:'block'}} alt="maps"/>}<div style={{padding:'14px',fontWeight:900,color:'white',background:'#1a73e8',textAlign:'center'}}>Ver no Maps</div></a> : null}
</div>
</div>
</div>
</div>
