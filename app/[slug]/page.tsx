...
const youtubeId = data.youtube_topo||'vMzKWhcSMCY'
...
<iframe src={`https://www.youtube.com/embed/${youtubeId}`} style={{width:'100%',height:'100%',border:'none'}} allowFullScreen title="video"/>
</div>
